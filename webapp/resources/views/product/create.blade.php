    ...
    <div class="card card-primary">
        ...
        <div class="card-block">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-group">
                    <select class="c-select form-control boxed col-sm-8" name="dom_ship">
                        <option value="flat">Cargo de envío fijo</option>
                        <option value="calculated">El costo varia de acuerdoa la ubicación del comprador</option>
                        <option value="freight">Envio de carga (para productos por encima de 30 Kg)</option>
                        <option value="no_ship">Recogida local</option>
                    </select>
                    </div>
                    <div class="form-group">
                        {{ Form::label('ser_ship', 'Servicio de envio', ['class' => 'col-sm-10 col-form-label']) }}
                        <div class="row">
                        <select class="c-select form-control boxed col-sm-4" name="dom_ship">
                            <option value="x">x</option>
                            <option value="y">y</option>
                            <option value="z">z</option>
                        </select>
                            {{ Form::label('cost_ship', 'Costo', ['class' => 'col-sm-1 col-form-label']) }}
                            {{ Form::text('cost_ship', '', ['class' => 'form-control col-sm-1 ', 'placeholder' => '']) }}
